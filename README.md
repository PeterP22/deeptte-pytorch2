...
- [x] Deploy as an inference API + map console — deployed on Railway (chosen over Azure simply because I'm already in the Railway ecosystem)
- [ ] Results write-up
